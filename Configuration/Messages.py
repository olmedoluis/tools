MESSAGES = {
    ...
    "branch-rename-place_holder": "What's the new name for the branch?",
    "branch-rename-success": "\n {th_success}{ic_success} The branch {pm_old_name} has been renamed to {pm_new_name}!\n",
    "branch-rename-title": "{th_normal}What's the new name for the branch?",
    ...
    "error-branch-rename-not_valid": "\n {th_error}{ic_error} Error: The Branch name is not valid\n",
    "error-branch-rename-repeated_name": "\n {th_error}{ic_error} Error: The branch name already exist\n",
